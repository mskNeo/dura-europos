...
// import data from './demos/hoard_1_td.csv'
...
<div class="input_div">
        ...
        <div class="input_div">
            ...
            <input type="radio" id="2sdev" name="filter" value=2 style="margin-left: 7px">
            <label for="2sdev">&plusmn;2&sigma;</label>
            <input type="radio" id="3sdev" name="filter" value=3 style="margin-left: 7px">
            <label for="3sdev">&plusmn;3&sigma;</label>
            <input type="radio" id="all" name="filter" value=0 checked="checked" style="margin-left: 7px">
            <label for="3sdev">None</label>
            <input type="button" id="filter_submit" value="Filter" onclick="handleFilter()" style="margin-left: 7px">
        </div>
    ...
    render(){
      return (
        <div className="vizpage">
          ...
          <p className='graph'>Interactive Scatterplot</p>
            <InnerHTML html={html} />
        </div>
